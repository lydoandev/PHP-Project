	...
	<div class="admin">
		...
		<div class="content">
			...
			<div class="container">
             ...
             <li class="active">
               <a href="administrator.php"><span><i class="fa fa-list-alt" style="color: #3399ff;"></i></span> Quản lí đơn hàng</a>
             </li>
             <li>
               <a href="qlgiohang.php"><span><i class="fa fa-shopping-cart" style="color: #ffff66;"></i></span> Quản lí giỏ hàng</a>
             </li>
             <li>
